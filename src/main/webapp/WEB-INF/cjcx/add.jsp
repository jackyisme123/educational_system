...
<body>
	...
	<div class="content">
	    ...
	    <div>
	                                学&nbsp&nbsp&nbsp&nbsp号:<input type="text" name="stuId" /> <span>*必须填写</span>
		  <p></>课程编号:<input type="text" name="courseId" /> <span>*必须填写</span>
		  <p></>学&nbsp&nbsp&nbsp&nbsp科:<input type="text" name="courseName" /> <span>*必须填写</span></p> 
	      <p></>任课老师:<input type="text" name="teacherName" /> <span>*必须填写</span></p>
	      <p></>成&nbsp&nbsp&nbsp&nbsp绩:<input type="text" name="scoreNum" /> <span>*必须填写</span></p>
