...
<body>
	...
	<div class="content">
		...
		<form action="addCourse.do" method="post" class="course">
			<div>
			<table class="table" >
				<tr>
					<td>课程代码：<input class="input" type="text" name="courseId"/></td>
					<td>课程名：<input class="input" type="text" name="courseName"/></td>
				</tr>
				<tr>
					<td>教师：<input class="input" type="text" name="teacherName"/></td>
					<td>上课地点：<input class="input" type="text" name="classroomName"/></td>
				</tr>
				<tr>	
					<td>上课时间：<input class="input" type="text" name="classDate"/></td>
					<td>考试时间：<input class="input" type="text" name="examDate"/></td>
				</tr>
			</table>
			</div>
				<div class="but_div">
